...
class WPN{            
    ...
    public function get_access_token(){
        ...
        $post_fields = "grant_type=client_credentials&client_id=$this->sid&client_secret=$this->secret&scope=notify.windows.com";
    ...
    public function build_tile_xml($title, $message){
		$msg = '<toast>
					<visual>
    ...
    public function post_tile($uri, $xml_data, $type = WPNTypesEnum::Toast, $tileTag = ''){
        ...
        $headers = array('Content-Type: text/xml', "Content-Length: " . strlen($xml_data), "X-WNS-Type: $type",  'X-NotificationClass: 2', "Authorization: Bearer $this->access_token");
        if($tileTag != ''){
